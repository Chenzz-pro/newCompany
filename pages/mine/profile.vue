<template>
	...
	/* 顶部用户信息区 */
	.user-header {
		background: linear-gradient(180deg, rgba(0,229,255,0.2) 0%, rgba(123,47,253,0.15) 100%);
	...
	.user-header::after {
		...
		height: 1rpx;
		background: linear-gradient(90deg, transparent, #00E5FF, #7B2FFD, transparent);
	}
	...
	.avatar-large {
		...
		box-shadow: 0 0 24rpx rgba(0,229,255,0.3);
	}
	...
	.avatar-placeholder-large {
		...
		border: 3rpx solid rgba(0,229,255,0.4);
		box-shadow: 0 0 24rpx rgba(0,229,255,0.2);
	}
	...
	.modal-content {
		...
		border-radius: 16rpx;
		padding: 40rpx 30rpx;
		border: 1rpx solid rgba(123,47,253,0.3);
		box-shadow: 0 0 40rpx rgba(123,47,253,0.2);
	}
