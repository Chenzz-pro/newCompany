<template>
	...
	/* 顶部区域 */
	.header-bg {
		background: linear-gradient(180deg, rgba(10,14,39,0.98) 0%, rgba(18,24,56,0.95) 50%, rgba(18,24,56,0.3) 100%);
	...
	.header-bg::after {
		...
		height: 1rpx;
		background: linear-gradient(90deg, transparent, rgba(0,229,255,0.4), rgba(123,47,253,0.4), transparent);
	}
	...
	.mascot-box {
		...
		box-shadow: 0 0 20rpx rgba(0,229,255,0.15), 0 0 32rpx rgba(123,47,253,0.1);
	}
	...
	.section-card {
		...
		box-shadow: 0 8rpx 32rpx rgba(0,0,0,0.3), 0 0 20rpx rgba(123,47,253,0.1);
	}
	...
	@keyframes sideGlow {
		0%,100% { opacity: 0.5; box-shadow: 0 0 8rpx rgba(0,229,255,0.2); }
		50% { opacity: 0.9; box-shadow: 0 0 16rpx rgba(0,229,255,0.5); }
	}
	...
	.list-item {
		...
		align-items: center;
		padding: 28rpx 0;
		border-bottom: 1rpx solid rgba(123,47,253,0.1);
		position: relative;
	}
	...
	.badge {
		...
		padding: 0 8rpx;
		margin-right: 12rpx;
		box-shadow: 0 0 12rpx rgba(255,46,196,0.3);
	}
	</style>
